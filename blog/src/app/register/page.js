...
const Register = () => {
  return (
    <section className='p-4'>
      ...
      <h2 className='text-gray-900 text-center text-lg mb-4 font-medium title-font'>Join Us!</h2>
      <form>
      <div className='relative mb-4'>
        <input 
        className='w-full bg-white rounded border border-gray-300 foucs:border-gray-500 focus:ring-2 rocus:ring-gray-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out' placeholder='Username'
        />
      </div>
      <div className='relative mb-4'>
        <input 
